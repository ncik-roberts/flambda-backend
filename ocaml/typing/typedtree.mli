...
and function_param =
  {
    ...
    *)
    ...
    fp_sort: Layouts.sort;
    fp_mode: Mode.Alloc.t;
    fp_curry: function_curry;
    fp_newtypes: (string loc * layout_annotation option) list;
...
and function_param_kind =
  ...
  | Tparam_optional_default of pattern * expression * Layouts.sort
